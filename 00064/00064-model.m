...
category:        Test
synopsis:        WeibullDistribution test
...
Test of the WeibullDistribution function from UncertML as used in the 'distrib' package.
...
; weibull(scale, shape) : WeibullDistribution from UncertML

There is one event:

[{width:30em,margin: 1em auto}|  *Event*  |  *Trigger*  | *Event Assignments* |
| E0 | $t >= 0.5$ | $X = weibull(2, 0.5)$ |
|  |  | $t = -0.5$ |]
