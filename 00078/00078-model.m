...
Test of the ExponentialDistribution function from UncertML as used in the 'distrib' package, with an upper inclusive bound.
...
; truncated_exponential(rate, truncationUpperInclusiveBound) : ExponentialDistribution from UncertML

There is one event:

[{width:30em,margin: 1em auto}|  *Event*  |  *Trigger*  | *Event Assignments* |
| E0 | $t >= 0.5$ | $X = truncated_exponential(1, 0.75)$ |
|  |  | $t = -0.5$ |]
