...
; truncated_exponential() : ExponentialDistribution from UncertML, rate = 1, truncationLowerInclusiveBound = 0.25, truncationUpperInclusiveBound = 0.75

There is one event:

[{width:30em,margin: 1em auto}|  *Event*  |  *Trigger*  | *Event Assignments* |
| E0 | $t >= 0.5$ | $X = truncated_exponential()$ |
|  |  | $t = -0.5$ |]
