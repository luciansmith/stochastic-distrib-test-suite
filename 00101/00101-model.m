...
; upper_truncated_normal(mean, stddev) : NormalDistribution from UncertML, truncationLowerInclusiveBound = -0.5, truncationUpperInclusiveBound = 0.5

There is one event:

[{width:30em,margin: 1em auto}|  *Event*  |  *Trigger*  | *Event Assignments* |
| E0 | $t >= 0.5$ | $X = upper_truncated_normal(0, 0.5)$ |
|  |  | $t = -0.5$ |]
