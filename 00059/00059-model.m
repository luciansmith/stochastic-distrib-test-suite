...
category:        Test
synopsis:        StudentTDistribution test
...
Test of the StudentTDistribution function from UncertML as used in the 'distrib' package.
...
; student_t(location, scale, degreesOfFreedom) : StudentTDistribution from UncertML

There is one event:

[{width:30em,margin: 1em auto}|  *Event*  |  *Trigger*  | *Event Assignments* |
| E0 | $t >= 0.5$ | $X = student_t(0, 1, 4)$ |
|  |  | $t = -0.5$ |]
