...
category:        Test
synopsis:        InverseGammaDistribution test
...
Test of the InverseGammaDistribution function from UncertML as used in the 'distrib' package.
...
; inverse_gamma(shape, scale) : InverseGammaDistribution from UncertML

There is one event:

[{width:30em,margin: 1em auto}|  *Event*  |  *Trigger*  | *Event Assignments* |
| E0 | $t >= 0.5$ | $X = inverse_gamma(5, 6)$ |
|  |  | $t = -0.5$ |]
