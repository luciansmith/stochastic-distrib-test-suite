...
category:        Test
synopsis:        LogisticDistribution test
...
Test of the LogisticDistribution function from UncertML as used in the 'distrib' package.
...
; logistic(location, scale) : LogisticDistribution from UncertML

There is one event:

[{width:30em,margin: 1em auto}|  *Event*  |  *Trigger*  | *Event Assignments* |
| E0 | $t >= 0.5$ | $X = logistic(1, 2)$ |
|  |  | $t = -0.5$ |]
