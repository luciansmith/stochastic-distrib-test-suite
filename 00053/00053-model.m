...
Test of the FDistribution function from UncertML as used in the 'distrib' package.
...
; f_dist(denominator, numerator) : FDistribution from UncertML

There is one event:

[{width:30em,margin: 1em auto}|  *Event*  |  *Trigger*  | *Event Assignments* |
| E0 | $t >= 0.5$ | $X = f_dist(4, 6)$ |
|  |  | $t = -0.5$ |]
