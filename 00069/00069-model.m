...
Test of the NormalDistribution function from UncertML as used in the 'distrib' package, with a negative lower truncation bound.
...
; lower_truncated_normal(mean, stddev, truncationLowerInclusiveBound) : NormalDistribution from UncertML

There is one event:

[{width:30em,margin: 1em auto}|  *Event*  |  *Trigger*  | *Event Assignments* |
| E0 | $t >= 0.5$ | $X = lower_truncated_normal(0, 1.5, -0.5)$ |
|  |  | $t = -0.5$ |]
