...
category:        Test
synopsis:        ParetoDistribution test
...
Test of the ParetoDistribution function from UncertML as used in the 'distrib' package.
...
; pareto(scale, shape) : ParetoDistribution from UncertML

There is one event:

[{width:30em,margin: 1em auto}|  *Event*  |  *Trigger*  | *Event Assignments* |
| E0 | $t >= 0.5$ | $X = pareto(2, 10)$ |
|  |  | $t = -0.5$ |]
