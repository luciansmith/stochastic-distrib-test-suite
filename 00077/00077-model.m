...
Test of the ExponentialDistribution function from UncertML as used in the 'distrib' package, with a lower inclusive bound.
...
; truncated_exponential(rate, truncationLowerInclusiveBound) : ExponentialDistribution from UncertML

There is one event:

[{width:30em,margin: 1em auto}|  *Event*  |  *Trigger*  | *Event Assignments* |
| E0 | $t >= 0.5$ | $X = truncated_exponential(1, 0.25)$ |
|  |  | $t = -0.5$ |]
