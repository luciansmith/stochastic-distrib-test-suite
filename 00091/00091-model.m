...
category:        Test
synopsis:        GeometricDistribution test
...
Test of the GeometricDistribution function from UncertML as used in the 'distrib' package.
...
; predefined_normal_with_variance(variance) : NormalDistribution from UncertML, mean = 0

There is one event:

[{width:30em,margin: 1em auto}|  *Event*  |  *Trigger*  | *Event Assignments* |
| E0 | $t >= 0.5$ | $X = predefined_normal_with_variance(1.5)$ |
|  |  | $t = -0.5$ |]
